...
public class JedisUtilTest {
  ...
  public static void close() {
    JedisUtil.getInstance().colseJedis(jedis, ipAddr, port);
  }
  ...
  public void testString() throws InterruptedException {
    ...
    System.out.println(
        "增加多个键值对：" + jedis.mset("key01", "value01", "key02", "value02", "key03", "value03"));
    ...
    System.out.println("===========获取原值，更新为新值==========");// GETSET is an atomic set this value and
